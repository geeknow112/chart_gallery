...
Module Module1
    ...
    Sub ConnectMySql()
        ...
        Const DB_Name As String = "stocks_jpx400"
        ...
        Using Conn As New MySqlConnection("Database=" + DB_Name _
            ...
            'Dim securitiesCodes() As Integer = StockCodes.SetNikkei225()
            Dim securitiesCodes() As Integer = StockCodes.SetJpx400()
            ...
            For securitiesCode = 0 To UBound(securitiesCodes)
                ...
                'max_date取得
                Dim query = "select max(date) as max_date from stocks_jpx400.s" + code + " limit 1"
                Dim cmd As MySqlCommand = New MySqlCommand(query, Conn)
